...
$checks = array(
	...
	'compact header breakpoint'  => array( $css, '@media (max-width: 1320px)' ),
	'compact header behavior'    => array( $js, "window.matchMedia('(max-width: 1320px)')" ),
	'duplicate header cta hidden' => array( $css, '.agris-header-actions > .agris-button { display: none; }' ),
	...
	'closed nested flyout hidden' => array( $css, '.agris-menu .sub-menu .sub-menu { display: none; }' ),
	'open nested flyout visible' => array( $css, '.agris-menu li.is-submenu-open > .sub-menu { display: grid;' ),
