...
$checks = array(
	...
	'PDF preview switch'        => array( $widget, "'enable_pdf_preview'" ),
	'PDF-only preview guard'    => array( $widget, "'PDF' === \$document['type']" ),
	'PDF preview trigger'       => array( $widget, 'data-agris-pdf-preview' ),
