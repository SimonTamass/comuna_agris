...
$checks = array(
	...
	'leadership schedule widget' => array( $applier, "'agris-schedule-grid'" ),
	'council member widget' => array( $applier, "'agris-council-members'" ),
	'council distribution widget' => array( $applier, "'agris-stats-bars'" ),
	'public document widget' => array( $applier, "'agris-document-grid'" ),
	'contact details widget' => array( $applier, "'agris-contact-details'" ),
	'contact form widget' => array( $applier, "'agris-contact-form'" ),
	'local home hero media' => array( $applier, "'2018/07/hatter-slider-46.jpg'" ),
	'local page hero media' => array( $applier, "'2019/02/egriii.jpg'" ),
	'bilingual Romanian brand' => array( $applier, "'Primăria · Egri Község'" ),
	'webmail action' => array( $applier, 'https://server84.romania-webhosting.com:2096/' ),
	'Romanian municipality route' => array( $applier, "'location'      => \$this->page_url( array( 'localizarea-comuna' )" ),
	...
	'dynamic home updates' => array( $home_hero, "function updates_for_display" ),
	'date-ordered home updates' => array( $home_hero, "'orderby'             => 'date'" ),
	'Polylang home updates' => array( $home_hero, "pll_get_post_language" ),
	'dynamic Romanian home config' => array( $applier, "'updates_source' => 'dynamic'" ),
	'editable page background' => array( $page_hero, "add_control( 'background'" ),
	'council display count' => array( $stats, "'display_value'" ),
	'background image rendering' => array( $css, 'var(--agris-page-image,none)' ),
);
...
foreach ( array( 'localizarea-comuna', 'conponenta-consiliul-local', 'formulare-tipizate', 'monitorul-oficial-local', '/contact/' ) as $route ) {
