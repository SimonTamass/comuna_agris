...
final class News_Grid extends Base {
	...
	protected function register_controls(): void {
		...
		$this->add_control( 'empty_text', array( 'label' => __( 'Üres állapot', 'comuna-agris' ), 'type' => Controls_Manager::TEXT, 'default' => 'Nu există articole publicate pentru această selecție.' ) );
		$this->add_control( 'read_more_text', array( 'label' => __( 'Tovább felirat', 'comuna-agris' ), 'type' => Controls_Manager::TEXT, 'default' => 'Citește mai mult →' ) );
