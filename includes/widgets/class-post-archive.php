...
final class Post_Archive extends Base {
	...
	protected function render(): void {
		...
		if ( 'yes' === $s['show_archive_header'] ) : ?><header class="agris-archive-header agris-title-band"><div class="agris-title-band-inner"><div class="agris-breadcrumbs"><a <?php echo self::link_attrs( $s['home_url'] ); ?>><?php echo esc_html( $s['home_label'] ); ?></a><span>/</span><span><?php echo esc_html( $plain_title ); ?></span></div><div class="agris-kicker"><?php echo esc_html( $s['archive_kicker'] ); ?></div><h1><?php echo wp_kses_post( $title ); ?></h1><?php if ( is_archive() ) : ?><div class="agris-title-description"><?php the_archive_description(); ?></div><?php endif; ?></div></header><?php endif;
